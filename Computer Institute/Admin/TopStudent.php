...
<link rel="stylesheet" href="Css/TopStudent.css">
<section id="DashBoard">
    ...
    <section id="Teacher-Page">
        ...
        <div id="Teacher_1">
            <div id="TopBar">
                <h2>Best Students</h2>
                <button id="AddTeacherBtn">Add Students</button>
            </div>
        ...
        <div id="Teacher_2">
            ...
            <div class="TeacherForm" id="TeacherForm">
                <form>
                    ...
                    <input type="text" name="Course" class="Position" placeholder="Enter Course">
...
<script src="Js/TopStudent.js"></script>