<?php
    ...
    $UdpateQuery = " UPDATE `topstudent` SET `TopStudent_Img`=:NewName,`TopStudent_Name`=:Name,`TopStudent_Course`=:Course WHERE TopStudent_ID = :StudentID ";
