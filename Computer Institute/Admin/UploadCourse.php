...
<section id="DashBoard">
    ...
    <section id="UploadCourse-Page">
        ...
        <div id="UplaodCourse_1">
            ...
            <div id="Top_Title">
                <h2>Add Course</h2>
                <button id="Course_Uplaod_Btn">Upload Now</button>
            </div>
            ...
            <div id="Form">
                <form enctype="multipart/form-data">
                    <div id="Course_Details">
                        ...
                        <div id="BasicD">
                            <input type="file" hidden name="Img" id="CourseFile">
                            <div id="CourseImg" onclick="document.getElementById('CourseFile').click();">
                                ...
                                <img style="display: none;" alt="Course_Image">
